...
| AG5 | [PHASES/AG5-verify-and-merge-gate.md](PHASES/AG5-verify-and-merge-gate.md) | Full verification + pedagogical merge note + PR checklist; merge only by named human | BLOCKED on AG4; DONE when cold review green **and** product owner records merge decision (merge itself is outside agent authority). May record `AG6_DEFERRED` |
