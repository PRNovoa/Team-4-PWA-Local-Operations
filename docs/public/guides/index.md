...
description: Every guide for running, teaching, learning from, and contributing to TTOD, in one place.
permalink: /guides/
---
...
The local-setup and contributing guides apply whether you're evaluating the instructor reference
or building your assigned module as a student — the mechanics (cloning, running, opening a PR) are
the same either way. [Teaching]({{ '/teaching/' | relative_url }}) is where the assignment-specific
content lives.
